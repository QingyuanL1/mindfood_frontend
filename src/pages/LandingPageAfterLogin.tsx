    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="text-center px-4 py-8 md:py-24">
        <div className="max-w-3xl mx-auto">
          ...
          <button
            onClick={() => navigate('/survey-prediabetes')}
            className="mt-4 px-6 py-2 bg-[#FF9466] hover:bg-[#FF7A45] text-white rounded-lg transition duration-300 ease-in-out"
          >
            Take Prediabetes Risk Assessment
          </button>
        </div>
      </div>
